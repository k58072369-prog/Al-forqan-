...
function initDB() {
  ...
  if (contentCount.count === 0) {
    ...
    insertContent.run("sheikh_name", "فضيلة الشيخ سامح رشاد");
  ...
  if (studentCount.count === 0) {
    ...
    const s1 = insertStudent.run("1001", "أحمد محمد علي منصور", "محمد علي منصور", "01127225409", "الشيخ سامح رشاد", "حلقة الفجر المتميزة");
    ...
    const s3 = insertStudent.run("1003", "عمر محمود الشامي", "محمود الشامي", "01233445566", "الشيخ سامح رشاد", "حلقة فرسان القرآن");
    ...
    insertNews.run(
      ...
      null,
      "أقام مكتب الفرقان لتحفيظ القرآن الكريم حفل التكريم الشهري لطلابه المتفوقين في فروع الحفظ والمراجعة والسلوك القويم. وشهد الحفل توزيع الجوائز النقدية وشهادات التقدير بحضور الشيخ سامح رشاد وأولياء أمور الطلاب الكرام وسط فرحة عارمة.",
      "2026-05-28"
    );
    insertNews.run(
    ...
    insertLibrary.run(
      "youtube",
      "ثمار المداومة على حفظ القرآن الكريم - توجيهات الشيخ سامح رشاد",
